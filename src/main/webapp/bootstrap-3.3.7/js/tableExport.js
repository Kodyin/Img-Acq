    ...
    $.fn.extend({
        tableExport: function (options) {
            var defaults = {
                ...
                tbodySelector: 'tr',
                tfootSelector: 'tr', // set empty ('') to prevent export of tfoot data
                theadSelector: 'tr',
            ...
            if (defaults.type == 'csv' || defaults.type == 'tsv' || defaults.type == 'txt') {
                ...
                $tables.each(function () {
                    ...
                    //if (defaults.tfootSelector.length)
                    //    $data.push.apply($data, $table.find('tfoot').find(defaults.tfootSelector));
                ...
                if (defaults.pdfmake.enabled === true) {
                    ...
                    loadImages ( teOptions, function (imageCount) {
                        ...
                        $(el).filter(function() {
                            ...
                            if (typeof atOptions.beforePageContent !== 'function') {
                                atOptions.beforePageContent = function (data) {
                                    if (data.pageCount == 1) {
                                        var all = data.table.data.concat(data.table.headerRow);
                            ...
                            if (typeof teOptions.onBeforeAutotable === 'function')
                                teOptions.onBeforeAutotable($(this), teOptions.columns, teOptions.data, atOptions);

                            teOptions.doc.autoTable(teOptions.columns, teOptions.data, atOptions);
                        ...
                        if (typeof teOptions.data != 'undefined')
                            teOptions.data.length = 0;
                    ...
                    $row.each(function (colIndex) {
                        if ($(this).data("tableexport-display") == 'always' ||
                            ...
                            if (typeof (cellcallback) === "function") {
                                ...
                                // handle rowspans from previous data
                                ...
                                if (isColumnIgnored($row, colIndex + rowColspan) === false) {
                                    ...
                                    // store rowspan for following data
                                    if (Rowspan > 1) {
                                        for (r = 1; r < Rowspan; r++) {
